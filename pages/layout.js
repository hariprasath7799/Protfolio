  ...
  return (
    <div className={`h-screen lg:p-[0.8rem] flex flex-col select-none font-circular`}>
      <div className='lg:hidden'>
        <div className=' bg-DeepNightBlack text-gray-300 w-full h-10 flex items-center justify-between px-2 lg:hidden relative'>
      ...
      <div className='flex relative h-full justify-between gap-x-3'>
        ...
        <div className={`hidden lg:block absolute lg:w-20 lg:relative bg-DeepNightBlack shadow-2xl rounded-xl overflow-hidden`}>
          ...
          <span className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90 flex items-center justify-center text-center text-xl text-gray-300 font-extrabold tracking-widest'>
            NavBar
          </span>
        </div>
